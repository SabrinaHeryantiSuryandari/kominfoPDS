    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          {{-- Print ALL --}}
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#printall" aria-expanded="false" aria-controls="ui-basic">
              <i class="icon-layout menu-icon"></i>
              <span class="menu-title">Print all</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="printall">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/allpengadaan1"> <i class="fa-solid fa-less-than-equal "></i> 50juta</a></li>
                <li class="nav-item"> <a class="nav-link" href="/allpengadaan2"> <i class="fa-solid fa-greater-than "></i> 50juta</a></li>
              </ul>
            </div>
          </li>
