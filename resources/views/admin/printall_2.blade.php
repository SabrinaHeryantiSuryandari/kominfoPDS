                    ...
                    <table id="data1" class="table table-bordered" cellspacing="0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                                <a class="btn btn-info" href="{{ route('allpengadaan2.show',$p->id) }}">Detail</a>
                                <a class="btn btn-danger " href="{{route('allpengadaan2.print',$p->id)}}">Cetak PDF <i class="fa fa-save"></i></a>
